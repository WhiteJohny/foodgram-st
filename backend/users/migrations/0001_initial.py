    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Укажите ваш email', max_length=254, unique=True, verbose_name='Адрес электронной почты')),
                ...
                ('avatar', models.ImageField(default='', help_text='Загрузите ваш аватар', upload_to='avatars/', verbose_name='Аватар')),
